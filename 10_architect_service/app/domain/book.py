'''
АГ
Предлагаю расширить код для данного файла, чтобы студенты лучше разобрались с доменной логикой 
и как она работает. Предлагаю попробовать использовать следующий код:
'''
