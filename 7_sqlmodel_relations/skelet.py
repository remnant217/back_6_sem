...
Идея такая же - при вызове функции create_item_repository() вместо user_id=user_id укажем
user=user.
'''
...
'''
Итак, изменения внесены, попробую запустить наше приложение и создать новый item 
